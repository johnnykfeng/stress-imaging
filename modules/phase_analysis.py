...
if __name__ == "__main__":
    ...
    axs[0,0].set_title('isoclinic phase')

    axs[0, 1].imshow(phase2_unwrap, cmap='jet')
    axs[0, 1].set_title('isoclinic phase unwrapped')

    axs[1,0].imshow(delta, cmap='jet')
    axs[1,0].set_title('isochromatic phase')

    axs[1, 1].imshow(delta_unwrap, cmap='jet')
    axs[1, 1].set_title('isochromatic phase unwrapped')
